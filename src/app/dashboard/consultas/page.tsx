    ...
    reader.onload = (evt) => {
      ...
      rows.forEach((cols, idx) => {
        ...
        batchWorkOrders.push({
          ...
          diagnostic_notes: `Registro Histórico Importado. Quinquenal: ${record.quinquennialDate} • Chip Anual: ${record.chipExpiryDate} • Técnico: ${record.technicianName}${record.discounts ? ` • [DESCUENTO]: ${record.discounts}` : ""}${record.creditAmount > 0 ? ` • [CREDITO]: ${record.creditAmount}` : ""}`,
          observations: "",
